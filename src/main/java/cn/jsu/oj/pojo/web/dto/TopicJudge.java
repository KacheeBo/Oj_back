 ...
 * describe:
 */
public class TopicJudge implements Serializable
{
    ...
    private boolean topicAnswer;

    public TopicJudge()
    {
    }

    public TopicJudge(Integer topicId, String topicName, Integer topicDifficulty, Integer topicFraction, String topicDescription, String topicStem, Date topicTime, boolean topicPermission, Integer teacherId, Integer topicCount, boolean topicAnswer)
    {
    ...
    public void setTopicAnswer(boolean topicAnswer)
    {
        this.topicAnswer = topicAnswer;
    }
