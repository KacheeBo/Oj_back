 ...
 * describe:
 */
public class TopicDoubleOptions implements Serializable
{
    ...
    public TopicDoubleOptions()
    {
    }

    public TopicDoubleOptions(Integer topicId, String topicName, Integer topicDifficulty, Integer topicFraction, String topicDescription, String topicStem, Date topicTime, boolean topicPermission, Integer teacherId, Integer topicCount)
    {
