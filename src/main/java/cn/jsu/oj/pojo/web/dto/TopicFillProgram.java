...
/**
 * @author: suixuexue
 * @date: 2020/12/26 19:48
 * describe:
 */
public class TopicFillProgram implements Serializable
{
    ...
    public TopicFillProgram()
    {
    }

    public TopicFillProgram(Integer topicId, String topicName, Integer topicDifficulty, Integer topicFraction, String topicDescription, String topicStem, Date topicTime, boolean topicPermission, Integer teacherId, Integer topicCount, boolean topicTStatus, boolean topicAStatus, Integer topicTimeL, Integer topicMemoryL, Integer topicWeight)
    {
